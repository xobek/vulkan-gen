...
#define V_PI_2 2.0f * V_PI
#define V_HALF_PI 0.5f * V_PI
#define V_QUARTER_PI 0.25f * V_PI
#define V_ONE_OVER_PI 1.0f / V_PI
#define V_ONE_OVER_TWO_PI 1.0f / V_PI_2
#define V_SQRT_TWO 1.41421356237309504880f
#define V_SQRT_THREE 1.73205080756887729352f
#define V_SQRT_ONE_OVER_TWO 0.70710678118654752440f
#define V_SQRT_ONE_OVER_THREE 0.57735026918962576450f
#define V_DEG2RAD_MULTIPLIER V_PI / 180.0f
#define V_RAD2DEG_MULTIPLIER 180.0f / V_PI

// The multiplier to convert seconds to milliseconds.
#define V_SEC_TO_MS_MULTIPLIER 1000.0f

// The multiplier to convert milliseconds to seconds.
#define V_MS_TO_SEC_MULTIPLIER 0.001f

// A huge number that should be larger than any valid number used.
#define V_INFINITY 1e30f

// Smallest positive number where 1.0 + FLOAT_EPSILON != 0
#define V_FLOAT_EPSILON 1.192092896e-07f
...
VINLINE b8 is_power_of_2(u64 value) {
    return (value != 0) && ((value & (value - 1)) == 0);
}

API i32 vrandom();
API i32 vrandom_in_range(i32 min, i32 max);

API f32 fvrandom();
API f32 fvrandom_in_range(f32 min, f32 max);
 ...
 */
VINLINE vec2 vec2_create(f32 x, f32 y) {
    vec2 out_vector;
    out_vector.x = x;
    out_vector.y = y;
    return out_vector;
 ...
 */
VINLINE vec2 vec2_add(vec2 vector_0, vec2 vector_1) {
    return (vec2){
 ...
 * @return The resulting vector. 
 */
VINLINE vec2 vec2_sub(vec2 vector_0, vec2 vector_1) {
    return (vec2){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y};
}
 ...
 * @return The resulting vector. 
 */
VINLINE vec2 vec2_mul(vec2 vector_0, vec2 vector_1) {
    return (vec2){
        vector_0.x * vector_1.x,
        vector_0.y * vector_1.y};
}
 ...
 * @return The resulting vector. 
 */
VINLINE vec2 vec2_div(vec2 vector_0, vec2 vector_1) {
    return (vec2){
        vector_0.x / vector_1.x,
        vector_0.y / vector_1.y};
}
 ...
 */
VINLINE f32 vec2_length_squared(vec2 vector) {
 ...
 * @return The length.
 */
VINLINE f32 vec2_length(vec2 vector) {
    return vsqrt(vec2_length_squared(vector));
}
 ...
 */
VINLINE void vec2_normalize(vec2* vector) {
 ...
 */
VINLINE vec2 vec2_normalized(vec2 vector) {
 ...
 * @param vector_0 The first vector.
 * @param vector_1 The second vector.
 * @param tolerance The difference tolerance. Typically V_FLOAT_EPSILON or similar.
 ...
 */
VINLINE f32 vec2_distance(vec2 vector_0, vec2 vector_1) {
    vec2 d = (vec2){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y};
 ...
 */
VINLINE vec3 vec3_create(f32 x, f32 y, f32 z) {
    return (vec3){x, y, z};
}
 ...
 * @return A new vec3 
 */
VINLINE vec3 vec3_from_vec4(vec4 vector) {
 ...
 * @return A new vec4 
 */
VINLINE vec4 vec3_to_vec4(vec3 vector, f32 w) {
 ...
 * @return The resulting vector. 
 */
VINLINE vec3 vec3_add(vec3 vector_0, vec3 vector_1) {
    return (vec3){
        vector_0.x + vector_1.x,
        vector_0.y + vector_1.y,
 ...
 * @return The resulting vector. 
 */
VINLINE vec3 vec3_sub(vec3 vector_0, vec3 vector_1) {
    return (vec3){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y,
        vector_0.z - vector_1.z};
 ...
 * @return The resulting vector. 
 */
VINLINE vec3 vec3_mul(vec3 vector_0, vec3 vector_1) {
    return (vec3){
        vector_0.x * vector_1.x,
        vector_0.y * vector_1.y,
        vector_0.z * vector_1.z};
 ...
 */
VINLINE vec3 vec3_mul_scalar(vec3 vector_0, f32 scalar) {
    return (vec3){
        vector_0.x * scalar,
        vector_0.y * scalar,
        vector_0.z * scalar};
 ...
 * @return The resulting vector. 
 */
VINLINE vec3 vec3_div(vec3 vector_0, vec3 vector_1) {
    return (vec3){
        vector_0.x / vector_1.x,
        vector_0.y / vector_1.y,
        vector_0.z / vector_1.z};
 ...
 * @return The squared length.
 */
VINLINE f32 vec3_length_squared(vec3 vector) {
 ...
 * @return The length.
 */
VINLINE f32 vec3_length(vec3 vector) {
    return vsqrt(vec3_length_squared(vector));
}
 ...
 * @param vector A pointer to the vector to be normalized.
 */
VINLINE void vec3_normalize(vec3* vector) {
 ...
 * @return A normalized copy of the supplied vector 
 */
VINLINE vec3 vec3_normalized(vec3 vector) {
 ...
 */
VINLINE f32 vec3_dot(vec3 vector_0, vec3 vector_1) {
    f32 p = 0;
 ...
 */
VINLINE vec3 vec3_cross(vec3 vector_0, vec3 vector_1) {
    return (vec3){
 ...
 * @return The distance between vector_0 and vector_1.
 */
VINLINE f32 vec3_distance(vec3 vector_0, vec3 vector_1) {
    vec3 d = (vec3){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y,
        vector_0.z - vector_1.z};
 ...
 */
VINLINE vec4 vec4_create(f32 x, f32 y, f32 z, f32 w) {
    vec4 out_vector;
#if defined(USE_SIMD)
 ...
 * @return A new vec3 
 */
VINLINE vec3 vec4_to_vec3(vec4 vector) {
    return (vec3){vector.x, vector.y, vector.z};
}
 ...
 * @return A new vec4 
 */
VINLINE vec4 vec4_from_vec3(vec3 vector, f32 w) {
#if defined(USE_SIMD)
    vec4 out_vector;
    out_vector.data = _mm_setr_ps(x, y, z, w);
    return out_vector;
 ...
 * @return The resulting vector. 
 */
VINLINE vec4 vec4_add(vec4 vector_0, vec4 vector_1) {
    vec4 result;
     for (u64 i = 0; i < 4; ++i) {
 ...
 * @return The resulting vector. 
 */
VINLINE vec4 vec4_sub(vec4 vector_0, vec4 vector_1) {
    vec4 result;
    for (u64 i = 0; i < 4; ++i) {
        result.elements[i] = vector_0.elements[i] - vector_1.elements[i];
    }
 ...
 * @return The resulting vector. 
 */
VINLINE vec4 vec4_mul(vec4 vector_0, vec4 vector_1) {
    vec4 result;
    for (u64 i = 0; i < 4; ++i) {
        result.elements[i] = vector_0.elements[i] * vector_1.elements[i];
    }
 ...
 * @return The resulting vector. 
 */
VINLINE vec4 vec4_div(vec4 vector_0, vec4 vector_1) {
    vec4 result;
    for (u64 i = 0; i < 4; ++i) {
        result.elements[i] = vector_0.elements[i] / vector_1.elements[i];
    }
 ...
 * @return The squared length.
 */
VINLINE f32 vec4_length_squared(vec4 vector) {
 ...
 * @return The length.
 */
VINLINE f32 vec4_length(vec4 vector) {
    return vsqrt(vec4_length_squared(vector));
}
 ...
 * @param vector A pointer to the vector to be normalized.
 */
VINLINE void vec4_normalize(vec4* vector) {
 ...
 * @return A normalized copy of the supplied vector 
 */
VINLINE vec4 vec4_normalized(vec4 vector) {
    vec4_normalize(&vector);
    return vector;
}

VINLINE f32 vec4_dot_f32(
 ...
 */
VINLINE mat4 mat4_identity() {
    mat4 out_matrix;
    vzero_memory(out_matrix.data, sizeof(f32) * 16);
 ...
 */
VINLINE mat4 mat4_mul(mat4 matrix_0, mat4 matrix_1) {
 ...
 */
VINLINE mat4 mat4_orthographic(f32 left, f32 right, f32 bottom, f32 top, f32 near_clip, f32 far_clip) {
    mat4 out_matrix = mat4_identity();
 ...
 */
VINLINE mat4 mat4_perspective(f32 fov_radians, f32 aspect_ratio, f32 near_clip, f32 far_clip) {
    f32 half_tan_fov = vtan(fov_radians * 0.5f);
    mat4 out_matrix;
    vzero_memory(out_matrix.data, sizeof(f32) * 16);
 ...
 */
VINLINE mat4 mat4_look_at(vec3 position, vec3 target, vec3 up) {
    mat4 out_matrix;
    vec3 z_axis;
 ...
 */
VINLINE mat4 mat4_transposed(mat4 matrix) {
    mat4 out_matrix = mat4_identity();
 ...
 */
VINLINE mat4 mat4_inverse(mat4 matrix) {
...
VINLINE mat4 mat4_translation(vec3 position) {
    mat4 out_matrix = mat4_identity();
 ...
 */
VINLINE mat4 mat4_scale(vec3 scale) {
    mat4 out_matrix = mat4_identity();
...
VINLINE mat4 mat4_euler_x(f32 angle_radians) {
    mat4 out_matrix = mat4_identity();
    f32 c = vcos(angle_radians);
    f32 s = vsin(angle_radians);
...
VINLINE mat4 mat4_euler_y(f32 angle_radians) {
    mat4 out_matrix = mat4_identity();
    f32 c = vcos(angle_radians);
    f32 s = vsin(angle_radians);
...
VINLINE mat4 mat4_euler_z(f32 angle_radians) {
    mat4 out_matrix = mat4_identity();
...
VINLINE mat4 mat4_euler_xyz(f32 x_radians, f32 y_radians, f32 z_radians) {
 ...
 */
VINLINE vec3 mat4_forward(mat4 matrix) {
    vec3 forward;
 ...
 * @return A 3-component directional vector.
 */
VINLINE vec3 mat4_backward(mat4 matrix) {
    vec3 backward;
 ...
 * @return A 3-component directional vector.
 */
VINLINE vec3 mat4_up(mat4 matrix) {
    vec3 up;
    up.x = matrix.data[1];
    up.y = matrix.data[5];
    up.z = matrix.data[9];
 ...
 * @return A 3-component directional vector.
 */
VINLINE vec3 mat4_down(mat4 matrix) {
    vec3 down;
 ...
 * @return A 3-component directional vector.
 */
VINLINE vec3 mat4_left(mat4 matrix) {
    vec3 right;
 ...
 * @return A 3-component directional vector.
 */
VINLINE vec3 mat4_right(mat4 matrix) {
    vec3 left;
...
VINLINE quat quat_identity() {
    return (quat){0, 0, 0, 1.0f};
}

VINLINE f32 quat_normal(quat q) {
    return vsqrt(
        q.x * q.x +
        q.y * q.y +
        q.z * q.z +
...
VINLINE quat quat_normalize(quat q) {
...
VINLINE quat quat_conjugate(quat q) {
    return (quat){
        -q.x,
        -q.y,
        -q.z,
...
VINLINE quat quat_inverse(quat q) {
    return quat_normalize(quat_conjugate(q));
}

VINLINE quat quat_mul(quat q_0, quat q_1) {
    quat out_quaternion;
...
VINLINE f32 quat_dot(quat q_0, quat q_1) {
    return q_0.x * q_1.x +
           q_0.y * q_1.y +
           q_0.z * q_1.z +
           q_0.w * q_1.w;
...
VINLINE mat4 quat_to_mat4(quat q) {
    mat4 out_matrix = mat4_identity();
...
VINLINE mat4 quat_to_rotation_matrix(quat q, vec3 center) {
    mat4 out_matrix;
...
VINLINE quat quat_from_axis_angle(vec3 axis, f32 angle, b8 normalize) {
    const f32 half_angle = 0.5f * angle;
    f32 s = vsin(half_angle);
    f32 c = vcos(half_angle);
...
VINLINE quat quat_slerp(quat q_0, quat q_1, f32 percentage) {
    quat out_quaternion;
    ...
    f32 theta_0 = vacos(dot);          // theta_0 = angle between input vectors
    f32 theta = theta_0 * percentage;  // theta = angle between v0 and result
    f32 sin_theta = vsin(theta);       // compute this value only once
    f32 sin_theta_0 = vsin(theta_0);   // compute this value only once

    f32 s0 = vcos(theta) - dot * sin_theta / sin_theta_0;  // == sin(theta_0 - theta) / sin(theta_0)
 ...
 */
VINLINE f32 deg_to_rad(f32 degrees) {
    return degrees * V_DEG2RAD_MULTIPLIER;
}
 ...
 */
VINLINE f32 rad_to_deg(f32 radians) {
    return radians * V_RAD2DEG_MULTIPLIER;
}