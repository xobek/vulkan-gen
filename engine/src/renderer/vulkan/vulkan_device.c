...
b8 select_physical_device(vulkan_context* context) {
    ...
    const u32 max_physical_devices = 32;
...
void vulkan_device_destroy(vulkan_context* context) {
    ...
    INFO("Destroying graphics command pool..");
    if (context->device.graphics_command_pool) {
        ...
        context->device.graphics_command_pool = 0; // Ensures you do not accidentally use it after destruction
    }
